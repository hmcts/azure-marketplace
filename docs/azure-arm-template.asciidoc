...
* Security feature is enabled, and the {xpackdocs}/built-in-roles.html[built-in roles] `elastic`, `kibana` and
...
of sufficient size is chosen to be service the expected amount of traffic. A larger VM
